...
# my_anchors= [(236.44554455, 241.22079208),
#  (240.88114105  ,167.99049128),
#  ( 292.41512027  ,261.57250859),
#  ( 321.49306519  ,320.51040222),
#  ( 333.62808219  ,194.43013699),
#  ( 370.30125313  ,249.13734336),
#  ( 396.34071146  ,317.07667984),
#  ( 453.10053619  ,384.59785523),
#  ( 466.98214286  ,202.89285714),
#  ( 483.18303946  ,273.03274559),
#  ( 638.82702703 , 298.64864865),
#  (1669.82758621,  200.82758621)]
...
def write_results(prediction, num_classes, confidence=0.5, nms_conf=0.5):
...
def prep_label(label_file, classes):
    ...
    final_labels = nd.zeros(shape=(num_row_labels, num_classes + 5), dtype="float32")
    i = 0
    for label in labels:
