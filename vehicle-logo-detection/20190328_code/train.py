...
def arg_parse():
    ...
    "mxnet params file", default="my_mxnet_pro_3/data/pro_darknet4_mxnet.params", type=str)
...
if __name__ == '__main__':
    ...
    for epoch in range(500):
        ...
        net.save_parameters("my_mxnet_pro_3/data/pro_darknet4_mxnet.params")
