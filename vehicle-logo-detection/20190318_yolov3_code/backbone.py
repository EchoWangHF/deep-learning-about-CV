...
class TransformBlock(nn.HybridBlock):
    ...
    def hybrid_forward(self, F, x, *args, **kwargs):
        ...
        return F.concat(xy_pred, wh_pred, score_pred,dim=-1)


class DarkNet(nn.HybridBlock):
    def __init__(self, num_classes=1, input_dim=416):
        ...
        self.conv_bn_block_81 = ConvBNBlock(3 * (5), 1, 1, 0, use_bias=True, leaky=False)
        self.transform_0 = TransformBlock(13)
        ...
        self.conv_bn_block_93 = ConvBNBlock(3 * (5), 1, 1, 0, use_bias=True, leaky=False)
        self.transform_1 = TransformBlock(26)
        ...
        self.conv_bn_block_105 = ConvBNBlock(3 * (5), 1, 1, 0, use_bias=True, leaky=False)
        self.transform_2 = TransformBlock(52)
    ...
    def load_weights(self, weightfile, fine_tune=True):
...
if __name__ == '__main__':
    ...
    print(a.slice_axis(begin=4, end=5, axis=-1))
