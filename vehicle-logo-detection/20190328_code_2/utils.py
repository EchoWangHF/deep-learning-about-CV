...
# def my_parse_xml(xml_file,classes):
...
# def my_parse_xml_new(xml_file,classes):
#     root=ET.parse(xml_file).getroot()
...
def my_parse_xml_newnew(xml_file):
    root=ET.parse(str(xml_file[0])).getroot()
...
#         labels=my_parse_xml_newnew(label_file,classes)
...
def prep_label_new(label_file, classes):
    num_classes = len(classes)

    labels=my_parse_xml_newnew(label_file)
